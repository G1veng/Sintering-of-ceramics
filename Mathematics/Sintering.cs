...
namespace Mathematics
{
    public class Sintering
    {
        ...
        /// <param name="db0">Предэкспоненциальный множитель</param>
        /// <param name="ds0">Предэкспоненциальный множитель</param>
        /// <param name="eb">Энергия активации</param>
        /// <param name="es">Энергия активации</param>
        /// <param name="s">Удельная поверхностная энергия</param>
        /// <param name="eta0">Время изотермического спекания</param>
